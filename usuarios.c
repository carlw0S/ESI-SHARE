...
void perfiles_user(T_Usuarios *usuarios, int * n) //funcion que escribe los datos del usuario
{
   ...
   printf("modifique su contrasena (max: 8 caracteres):\n"); //escribe que cambie la contrase�a
   fgets(usuarios[i].Login, 9, stdin); //lee la nueva contrase�a
   }
...

{
   ...
   fgets(usuarios[i].User, 6, stdin);
    printf("Nueva contrase�a (max: 8 caracteres):");
...
int id;
 ...
 aux = *usuarios;
  ...
  printf("escriba el nombre de usuario y la contrase�a\n");
